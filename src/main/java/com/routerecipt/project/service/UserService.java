...
//	UserDTO UserSelectById(String u_id);		// 사용자 단건 조회
	User UserSelectById(String u_id);
	boolean checkDuplicateUserId(String userId); // 아이디 중복 확인 (Bloom Filter + DB)
}
